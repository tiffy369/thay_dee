 ...
 * Lightweight, standalone QR code generator
 */
(function(window) {
    ...
    QRCodeModel.prototype = {
        ...
        setupTypeInfo: function(test, maskPattern) {
            ...
            for (var i = 0; i < 15; i++) {
                ...
                else if (i === 8) this.modules[8][15 - i] = mod;
    ...
    window.QRCode = function(targetEl, options) {
        ...
        function makeCode(text) {
            targetEl.innerHTML = "";
            var qr = new QRCodeModel(-1, opts.correctLevel);
            qr.addData(text);
            qr.make();
            var count = qr.getModuleCount();
            var tileW = opts.width / count;
            var tileH = opts.height / count;
        ...
        return {
            makeCode: makeCode,
            clear: function() { targetEl.innerHTML = ""; },
